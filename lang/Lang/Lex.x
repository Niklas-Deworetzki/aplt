...
resWords =
  b "True" 21
    (b "<" 11
       ...
       (b "Bool" 16
          (b ">" 14 (b "=>" 13 (b "=" 12 N N) N) (b "Arr" 15 N N))
          (b "Nat" 19 (b "False" 18 (b "Dist" 17 N N) N) (b "S" 20 N N))))
    (b "in" 32
       (b "distr" 27
          (b "\\" 24
             (b "[" 23 (b "Z" 22 N N) N) (b "case" 26 (b "]" 25 N N) N))
          (b "forall" 30
             (b "filter" 29 (b "else" 28 N N) N) (b "if" 31 N N)))
       (b "then" 37
          (b "of" 35 (b "iter" 34 (b "inj" 33 N N) N) (b "return" 36 N N))

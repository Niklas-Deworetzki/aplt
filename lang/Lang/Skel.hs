...
transIdent :: Lang.Abs.Ident -> Result
transIdent x = case x of
  Lang.Abs.Ident string -> failure x
...
transPExp x = case x of
  Lang.Abs.PLet ident pexp1 pexp2 -> failure x
  ...
  Lang.Abs.PDistr ptyp -> failure x
  Lang.Abs.PProj pexp ident -> failure x
  Lang.Abs.PAppT pexp ptyp -> failure x
...
transPLabExp x = case x of
  Lang.Abs.PLabExp ident pexp -> failure x

transPCaseExp :: Lang.Abs.PCaseExp -> Result
transPCaseExp x = case x of
  Lang.Abs.PCaseExp ident1 ident2 pexp -> failure x

transPTyp :: Lang.Abs.PTyp -> Result
transPTyp x = case x of
  Lang.Abs.PTBool -> failure x
  Lang.Abs.PTNat -> failure x
  Lang.Abs.PTVar ident -> failure x
  Lang.Abs.PTArr ptyp1 ptyp2 -> failure x
  Lang.Abs.PTDist ptyp -> failure x
...
transTMember x = case x of
  Lang.Abs.TMember ident ptyp -> failure x
  Lang.Abs.TMember1 ident ptyp -> failure x
